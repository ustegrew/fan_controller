...
U 1 1 59C7F318
P 6150 7300
F 0 "D3014" H 6150 7400 50  0000 C CNN
...
U 1 1 59C7F46A
P 6150 7700
F 0 "D3016" H 6150 7800 50  0000 C CNN
...
U 1 1 59C7F4D0
P 6850 7300
F 0 "D3015" H 6850 7400 50  0000 C CNN
...
U 1 1 59C7F50D
P 6850 7700
F 0 "D3017" H 6850 7800 50  0000 C CNN
...
U 1 1 59C80119
P 7900 9000
F 0 "C3010" H 7925 9100 50  0000 L CNN
...
U 1 1 59C85149
P 10200 6350
F 0 "D3013" H 10200 6450 50  0000 C CNN
...
U 1 1 59C8535C
P 10200 9950
F 0 "D3018" H 10200 10050 50  0000 C CNN
...
U 1 1 59C85458
P 10650 7250
F 0 "C3005" H 10675 7350 50  0000 L CNN
...
U 1 1 59D2C046
P 6150 4600
F 0 "D3009" H 6150 4700 50  0000 C CNN
...
U 1 1 59D2C04C
P 6150 5000
F 0 "D3011" H 6150 5100 50  0000 C CNN
...
U 1 1 59D2C052
P 6850 4600
F 0 "D3010" H 6850 4700 50  0000 C CNN
...
U 1 1 59D2C058
P 6850 5000
F 0 "D3012" H 6850 5100 50  0000 C CNN
...
U 1 1 5B42D5B3
P 7300 4100
F 0 "#FLG04" H 7300 4175 50  0001 C CNN
...
Wire Wire Line
	7900 1250 7900 1700
Wire Wire Line
	6650 1250 11700 1250
Wire Wire Line
	6350 2450 11700 2450
Wire Wire Line
	6650 4200 9900 4200
Wire Wire Line
...
U 1 1 5B42F1E8
P 7300 1150
F 0 "#FLG05" H 7300 1225 50  0001 C CNN
...
U 1 1 5B42F3CF
P 7300 2350
F 0 "#FLG06" H 7300 2425 50  0001 C CNN
...
U 1 1 5B42FAC9
P 7300 6700
F 0 "#FLG07" H 7300 6775 50  0001 C CNN
...
U 1 1 5B42FB87
P 7300 9400
F 0 "#FLG08" H 7300 9475 50  0001 C CNN
...
Text Notes 2550 10950 0    60   ~ 0
Notes:\n* I'm not sure how much we might get problems with the transients\n   created by the fan switch and the logic circuitry. Therefore we\n   provide a separate transformer for the signal circuitry and\n   all the other circuitry. This should keep the power\n   clean for the signalling and everything else.\n* The power requirements are different per circuit type:\n    * For the signalling we need +/- 15V\n    * For the periphery we need +18V\n    * For the logic and fan switch we need +5V
$Comp
L D_TVS D3004
U 1 1 5B5A5EA8
P 8900 1850
F 0 "D3004" H 8900 1950 50  0000 C CNN
F 1 "1.5KE36CA" H 8900 1750 50  0000 C CNN
...
U 1 1 5B5A5EAF
P 11850 1250
F 0 "F3001" V 11930 1250 50  0000 C CNN
F 1 "250mAF" V 11775 1250 50  0000 C CNN
F 2 "" V 11780 1250 50  0001 C CNN
...
U 1 1 5B5A5EB6
P 11850 2450
F 0 "F3002" V 11930 2450 50  0000 C CNN
F 1 "250mAF" V 11775 2450 50  0000 C CNN
F 2 "" V 11780 2450 50  0001 C CNN
...
U 1 1 5B5A5EC5
P 9600 1550
F 0 "D3001" H 9600 1650 50  0000 C CNN
F 1 "1.5KE22CA" H 9600 1450 50  0000 C CNN
...
U 1 1 5B5A5ECC
P 9600 2150
F 0 "D3007" H 9600 2250 50  0000 C CNN
F 1 "1.5KE22CA" H 9600 2050 50  0000 C CNN
F 2 "" H 9600 2150 50  0001 C CNN
F 3 "" H 9600 2150 50  0001 C CNN
	1    9600 2150
	0    -1   -1   0   
$EndComp
Text HLabel 12950 1850 2    60   UnSpc ~ 0
EARTH
Wire Wire Line
	8900 1700 8900 1250
...
Wire Wire Line
	9600 1850 12950 1850
Text Notes 14000 1850 0    60   ~ 0
Venue PE
Wire Wire Line
	12000 1250 12950 1250
Wire Wire Line
	12000 2450 12950 2450
$EndSCHEMATC
